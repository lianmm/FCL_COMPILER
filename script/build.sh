...
clang++ -std=c++17  -O2 -lm -L/extlibs -I/extlibs -lantlr4-runtime src/midend/*.cpp src/frontend/*.cpp src/backend/*.cpp src/*.cpp  -I src/baskend -I src/frontend -I src/midend -I src/backend/back_optimization -I src/midend/mid_optimization -o compiler 
