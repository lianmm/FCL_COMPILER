...
extern void output_symtable(struct node*);
extern int yylex();
...
{
       0,    53,    53,    61,    62,    65,    66,    67,    68,    69,
      72,    75,    77,    78,    81,    84,    85,    88,    89,    92,
      93,    95,    96,    98,   101,   103,   104,   105,   107,   108,
     109,   110,   111,   112,   113,   114,   115,   116,   119,   122,
     123,   126,   128,   129,   132,   133,   134,   135,   136,   137,
...
static const char *const yytname[] =
{
  ...
  "ForArgs", "ForArg", "Def", "DecList", "Exp", "Args", YY_NULLPTR
};
#endif
...
#line 1615 "sysy.tab.c"
  ...
  case 6:
#line 66 "sysy.y"
                                              {(yyval.ptr)=mknode(EXT_CONST_VAR_DEF,(yyvsp[-2].ptr),(yyvsp[-1].ptr),NULL,yylineno);}
