...
//  %type 定义非终结符的语义值类型
%type  <ptr> program ExtDefList ExtDef    ExtDecList FuncDec CompSt VarList VarDec ParamDec Stmt StmList DefList Def DecList Dec Exp Args Specifier
...
void semantic_Analysis0(struct node *ptr){}	
